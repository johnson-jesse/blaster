...
const Home: NextPage = () => {
  ...
  return (
    <div className='relative'>
      ...
      <div className='absolute hidden bottom-4 left-4 lg:block text-sm text-center' style={{ fontFamily: 'Atari Classic Int' }}><div>Fire space</div><div>Arrow move</div></div>
